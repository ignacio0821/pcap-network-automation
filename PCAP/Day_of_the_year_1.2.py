...
def day_of_the_year(year, month, day):
    try:
        ...
        print(f"These are the day of the year: end=" ",")


print(day_of_the_year(2018, 2, 29))
print(day_of_the_year(1910, 5, 15))
print(day_of_the_year("1971", 8, 29))


#if __name__ == "__main__":
#    day_of_the_year() == is_date_valid(2018, 2, 29)
